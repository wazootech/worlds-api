...
> [!TIP]
> This is a high-friction deployment intended for platform operators. If you just want to run a single World instance, see [Server Self-Hosting](/server/hosting).
