...
they used the
[**Khipu**](https://en.wikipedia.org/wiki/Quipu)—a sophisticated and enigmatic
system of knotted, dyed strings that encoded numerical data, tax records, and
potentially narrative histories in a three-dimensional, tactile format.
