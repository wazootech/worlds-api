...
- **Hybrid architecture**: Utilize a [neuro-symbolic](/glossary/neuro-symbolic)
  framework. Pair neural intuition for meaning with symbolic precision for
  facts. This ensures your agents navigate a map of reality built on logical
...
automatically, and gracefully self-correct when they encounter unexpected
errors. Instead definitions of tasks that break when the environment changes,
grant your agents tool access and trust their native reasoning over a verifiable
state.
