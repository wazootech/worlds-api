...
The Worlds Platform utilizes a managed
[neuro-symbolic](/glossary/neuro-symbolic) infrastructure designed for
...
The **Worlds Console** acts as the system's brain. It manages identity through
...
The **Worlds API Server** handles RDF graph management,
[SPARQL](/glossary/sparql) execution, and
[hybrid search](/glossary/hybrid-search). This is the API layer where your
information lives.
...
- **Dedicated storage**: Each World maintains its own secondary libSQL database
  for [triples](/glossary/triple), chunks, and embeddings.
