---
title: "Local Setup"
description: "Run the entire Worlds Platform ecosystem—Console and World Server—locally using Deno and Node.js."
---

The Worlds Platform is designed with a **local-first** philosophy. You can boot the entire ecosystem—including the Management Console and any number of World instances—using only your local filesystem and Deno runtime.
...
Once the Console is running, it will automatically manage local World Server processes.
...
The World Server will automatically attempt to connect to the local Ollama instance at `http://127.0.0.1:11434`. You can override this in your environment:
