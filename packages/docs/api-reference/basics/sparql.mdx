...
**SPARQL** (SPARQL Protocol and RDF Query Language) is the standard query language for graph data. Worlds supports the full [SPARQL Endpoint](https://www.w3.org/TR/sparql11-overview/) specification.
