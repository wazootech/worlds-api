...
-- selectInvites is a query that gets invites with pagination
...
-- insertInvite is a query that inserts a new invite
...
-- selectInviteByCode is a query that finds an invite by code
...
-- updateInvite is a query that updates an invite (mark as redeemed in
...
-- deleteInvite is a query that deletes an invite
