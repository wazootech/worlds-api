...
export class ServiceAccounts {
  ...
  public async list(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to list service accounts: ${response.status} ${response.statusText}`,
      );
    }
  ...
  public async create(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to create service account: ${response.status} ${response.statusText}`,
      );
    }
  ...
  public async get(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to get service account: ${response.status} ${response.statusText}`,
      );
    }
  ...
  public async update(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to update service account: ${response.status} ${response.statusText}`,
      );
    }
  }
  ...
  public async delete(
    ...
    if (!response.ok) {
      throw new Error(
        `Failed to delete service account: ${response.status} ${response.statusText}`,
      );
    }
  }
}
