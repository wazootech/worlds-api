...
import { deserialize, getFormat, serialize } from "#/facts/rdf/rdf.ts";
...
`;
  ...
  assertEquals(quads[0].subject, "http://example.org/subject");
  assertEquals(quads[0].predicate, "http://example.org/predicate");
  assertEquals(quads[0].object, "object");
